...
var _ViewController = class _ViewController {
...
__name(_ViewController, "ViewController");
var ViewController = _ViewController;
var matches = /* @__PURE__ */ __name((view, id, params) => {
  if (!view) {
    return false;
  }
...
var convertToView = /* @__PURE__ */ __name((page, params) => {
  if (!page) {
    return null;
  }
...
var convertToViews = /* @__PURE__ */ __name((pages) => {
...
var Nav = (_a = class {
  ...
  componentDidLoad() {
    return __async(this, null, function* () {
      this.didLoad = true;
      this.rootChanged();
      this.gesture = (yield import("./swipe-back-B2YfOHRM-CXTCLZAK.js")).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
  ...
  setRouteId(id, params, direction, animation) {
    ...
    const commonOpts = {
      updateURL: false,
      viewIsReady: /* @__PURE__ */ __name((enteringEl) => {
        let mark;
        const p = new Promise((r) => mark = r);
        resolve({
          changed: true,
          element: enteringEl,
          markVisible: /* @__PURE__ */ __name(() => __async(this, null, function* () {
            mark();
            yield finish;
          }), "markVisible")
        });
  ...
  queueTrns(ti, done) {
    return __async(this, null, function* () {
      var _a3, _b;
      if (this.isTransitioning && ((_a3 = ti.opts) === null || _a3 === void 0 ? void 0 : _a3.skipIfBusy)) {
        return false;
      }
  ...
  prepareTI(ti) {
    ...
    (_a3 = ti.opts) !== null && _a3 !== void 0 ? _a3 : ti.opts = {};
  ...
  postViewInit(enteringView, leavingView, ti) {
    ...
    if (removeStart !== void 0 && removeCount !== void 0) {
      ...
      (_a3 = opts.direction) !== null && _a3 !== void 0 ? _a3 : opts.direction = "back";
    }
...
Nav.style = navCss;
var navLink = /* @__PURE__ */ __name((el, routerDirection, component, componentProps, routerAnimation) => {
...
@ionic/core/dist/esm/ion-nav_2.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-nav_2.entry-VQY2CGYT.js.map
