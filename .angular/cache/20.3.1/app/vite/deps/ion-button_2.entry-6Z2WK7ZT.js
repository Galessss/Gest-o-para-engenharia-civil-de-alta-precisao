...
var CACHED_MAP;
var getIconMap = /* @__PURE__ */ __name(() => {
...
var getNamedUrl = /* @__PURE__ */ __name((iconName, iconEl) => {
...
var getName = /* @__PURE__ */ __name((iconName, icon, mode, ios, md) => {
...
var getSrc = /* @__PURE__ */ __name((src) => {
  if (isStr(src)) {
    src = src.trim();
    if (isSrc(src)) {
      return src;
...
var isSrc = /* @__PURE__ */ __name((str) => str.length > 0 && /(\/|\.)/.test(str), "isSrc");
var isStr = /* @__PURE__ */ __name((val) => typeof val === "string", "isStr");
var toLower = /* @__PURE__ */ __name((val) => val.toLowerCase(), "toLower");
...
var isRTL = /* @__PURE__ */ __name((hostEl) => {
  if (hostEl) {
    if (hostEl.dir !== "") {
...
var validateContent = /* @__PURE__ */ __name((svgContent) => {
...
var isValid = /* @__PURE__ */ __name((elm) => {
  if (elm.nodeType === 1) {
...
var isSvgDataUrl = /* @__PURE__ */ __name((url) => url.startsWith("data:image/svg+xml"), "isSvgDataUrl");
var isEncodedDataUrl = /* @__PURE__ */ __name((url) => url.indexOf(";utf8,") !== -1, "isEncodedDataUrl");
...
__name(safeFallback, "safeFallback");
var getSvgContent = /* @__PURE__ */ __name((url, sanitize) => {
...
__name(getSvgByUrl, "getSvgByUrl");
...
var getIonMode2 = /* @__PURE__ */ __name(() => typeof document !== "undefined" && document.documentElement.getAttribute("mode") || "md", "getIonMode");
var createColorClasses2 = /* @__PURE__ */ __name((color) => {
  return color ? {
    "ion-color": true,
...
@ionic/core/dist/esm/ion-button_2.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-button_2.entry-6Z2WK7ZT.js.map
