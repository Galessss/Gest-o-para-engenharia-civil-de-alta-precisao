...
var FabButton = (_a2 = class {
  ...
  render() {
    ...
    }) }, h(TagType, Object.assign({ key: "914561622c0c6bd41453e828a7d8a39f924875ac" }, attrs, { class: "button-native", part: "native", disabled, onFocus: this.onFocus, onBlur: this.onBlur, onClick: /* @__PURE__ */ __name((ev) => openURL(href, ev, this.routerDirection, this.routerAnimation), "onClick") }, inheritedAttributes), h("ion-icon", { key: "2c8090742a64c62a79243667027a195cca9d5912", "aria-hidden": "true", icon: this.closeIcon, part: "close-icon", class: "close-icon", lazy: false }), h("span", { key: "c3e55291e4c4d306d34a4b95dd2e727e87bdf39c", class: "button-inner" }, h("slot", { key: "f8e57f71d8f8878d9746cfece82f57f19ef9e988" })), mode === "md" && h("ion-ripple-effect", { key: "a5e94fa0bb9836072300617245ed0c1b4887bac6" })));
  }
  get el() {
    return getElement(this);
  }
}, __name(_a2, "FabButton"), _a2);
FabButton.style = {
  ios: fabButtonIosCss,
  md: fabButtonMdCss
};
...
@ionic/core/dist/esm/ion-fab_3.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-fab_3.entry-ED4ILOYS.js.map
