...
var InputOTP = (_a = class {
  constructor(hostRef) {
    ...
    this.onFocus = (index) => (event) => {
      ...
      if (!this.isKeyboardNavigation) {
        ...
        (_a2 = this.inputRefs[finalIndex]) === null || _a2 === void 0 ? void 0 : _a2.focus();
      }
    ...
    this.onInput = (index) => (event) => {
      ...
      if (isAutofill) {
        ...
        setTimeout(() => {
          ...
          (_a3 = this.inputRefs[nextIndex]) === null || _a3 === void 0 ? void 0 : _a3.focus();
        }, 20);
      ...
      const cursorPos = (_a2 = input.selectionStart) !== null && _a2 !== void 0 ? _a2 : value.length;
    ...
    this.onPaste = (event) => {
      ...
      event.preventDefault();
      const pastedText = (_a2 = event.clipboardData) === null || _a2 === void 0 ? void 0 : _a2.getData("text");
      if (!pastedText) {
  ...
  setFocus(index) {
    return __async(this, null, function* () {
      ...
      if (typeof index === "number") {
        ...
        (_a2 = this.inputRefs[validIndex]) === null || _a2 === void 0 ? void 0 : _a2.focus();
      } else {
  ...
  focusNext(currentIndex) {
    ...
    if (currentIndex < length - 1) {
      (_a2 = inputRefs[currentIndex + 1]) === null || _a2 === void 0 ? void 0 : _a2.focus();
    }
  }
  /**
  ...
  getFirstEmptyIndex() {
    ...
    return (_a2 = values.findIndex((value) => !value || value === "")) !== null && _a2 !== void 0 ? _a2 : -1;
  }
  /**
  ...
  render() {
    ...
    const hasDescription = ((_b = (_a2 = el.querySelector(".input-otp-description")) === null || _a2 === void 0 ? void 0 : _a2.textContent) === null || _b === void 0 ? void 0 : _b.trim()) !== "";
    ...
    }) }, h("div", Object.assign({ key: "d7e1d4edd8aafcf2ed4313301287282e90fc7e82", role: "group", "aria-label": "One-time password input", class: "input-otp-group" }, inheritedAttributes), Array.from({ length }).map((_, index) => h(Fragment, null, h("div", { class: "native-wrapper" }, h("input", { class: "native-input", id: `${inputId}-${index}`, "aria-label": `Input ${index + 1} of ${length}`, type: "text", autoCapitalize: autocapitalize, inputmode, pattern, disabled, readOnly: readonly, tabIndex: index === tabbableIndex ? 0 : -1, value: inputValues[index] || "", autocomplete: "one-time-code", ref: /* @__PURE__ */ __name((el2) => inputRefs[index] = el2, "ref"), onInput: this.onInput(index), onBlur: this.onBlur, onFocus: this.onFocus(index), onKeyDown: this.onKeyDown(index), onPaste: this.onPaste })), this.showSeparator(index) && h("div", { class: "input-otp-separator" })))), h("div", { key: "3724a3159d02860971879a906092f9965f5a7c47", class: {
...
@ionic/core/dist/esm/ion-input-otp.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-input-otp.entry-OHR3KDEK.js.map
