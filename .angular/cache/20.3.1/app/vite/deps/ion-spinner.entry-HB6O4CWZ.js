...
}, __name(_a, "Spinner"), _a);
var buildCircle = /* @__PURE__ */ __name((spinner, duration, index, total) => {
...
var buildLine = /* @__PURE__ */ __name((spinner, duration, index, total) => {
  const data = spinner.fn(duration, index, total);
  data.style["animation-duration"] = duration + "ms";
...
@ionic/core/dist/esm/ion-spinner.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-spinner.entry-HB6O4CWZ.js.map
