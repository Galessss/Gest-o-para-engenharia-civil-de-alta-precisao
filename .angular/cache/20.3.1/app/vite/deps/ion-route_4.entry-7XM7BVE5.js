...
}, __name(_a2, "RouteRedirect"), _a2);
var ROUTER_INTENT_NONE = "root";
var ROUTER_INTENT_FORWARD = "forward";
var ROUTER_INTENT_BACK = "back";
var generatePath = /* @__PURE__ */ __name((segments) => {
  const path = segments.filter((s) => s.length > 0).join("/");
  return "/" + path;
}, "generatePath");
var generateUrl = /* @__PURE__ */ __name((segments, useHash, queryString) => {
...
var writeSegments = /* @__PURE__ */ __name((history, root, useHash, segments, direction, state, queryString) => {
...
var chainToSegments = /* @__PURE__ */ __name((chain) => {
  const segments = [];
...
var removePrefix = /* @__PURE__ */ __name((prefix, segments) => {
...
var readSegments = /* @__PURE__ */ __name((loc, root, useHash) => {
...
var printRoutes = /* @__PURE__ */ __name((routes) => {
...
var printRedirects = /* @__PURE__ */ __name((redirects) => {
...
var writeNavState = /* @__PURE__ */ __name((root, chain, direction, index, changed = false, animation) => __async(null, null, function* () {
  try {
...
var readNavState = /* @__PURE__ */ __name((root) => __async(null, null, function* () {
  const ids = [];
  let outlet;
  let node = root;
...
var waitUntilNavNode = /* @__PURE__ */ __name(() => {
...
var searchNavNode = /* @__PURE__ */ __name((root) => {
  if (!root) {
    return void 0;
  }
...
var matchesRedirect = /* @__PURE__ */ __name((segments, redirect) => {
...
var findRouteRedirect = /* @__PURE__ */ __name((segments, redirects) => {
  return redirects.find((redirect) => matchesRedirect(segments, redirect));
}, "findRouteRedirect");
var matchesIDs = /* @__PURE__ */ __name((ids, chain) => {
...
var matchesSegments = /* @__PURE__ */ __name((segments, chain) => {
...
var mergeParams = /* @__PURE__ */ __name((a, b) => {
  return a || b ? Object.assign(Object.assign({}, a), b) : void 0;
}, "mergeParams");
var findChainForIDs = /* @__PURE__ */ __name((ids, chains) => {
  let match = null;
  let maxMatches = 0;
  ...
  if (match) {
    return match.map((route, i) => {
      ...
      return {
        id: route.id,
        segments: route.segments,
        params: mergeParams(route.params, (_a5 = ids[i]) === null || _a5 === void 0 ? void 0 : _a5.params)
      };
    });
  }
  return null;
}, "findChainForIDs");
var findChainForSegments = /* @__PURE__ */ __name((segments, chains) => {
  let match = null;
  let bestScore = 0;
  for (const chain of chains) {
...
var computePriority = /* @__PURE__ */ __name((chain) => {
  let score = 1;
  let level = 1;
  for (const route of chain) {
    for (const segment of route.segments) {
...
var _RouterSegments = class _RouterSegments {
...
__name(_RouterSegments, "RouterSegments");
var RouterSegments = _RouterSegments;
var readProp = /* @__PURE__ */ __name((el, prop) => {
  if (prop in el) {
    return el[prop];
  }
...
var readRedirects = /* @__PURE__ */ __name((root) => {
...
var readRoutes = /* @__PURE__ */ __name((root) => {
  return flattenRouterTree(readRouteNodes(root));
}, "readRoutes");
var readRouteNodes = /* @__PURE__ */ __name((node) => {
...
var flattenRouterTree = /* @__PURE__ */ __name((nodes) => {
  const chains = [];
...
var flattenNode = /* @__PURE__ */ __name((chain, chains, node) => {
  chain = [
    ...chain,
    {
      id: node.id,
...
var Router = (_a3 = class {
  ...
  push(path, direction = "forward", animation) {
    return __async(this, null, function* () {
      var _a5;
      if (path.startsWith(".")) {
        const currentPath = (_a5 = this.previousPath) !== null && _a5 !== void 0 ? _a5 : "/";
  ...
  historyDirection() {
    ...
    if (win.history.state === null) {
      this.state++;
      win.history.replaceState(this.state, win.document.title, (_a5 = win.document.location) === null || _a5 === void 0 ? void 0 : _a5.href);
    }
...
@ionic/core/dist/esm/ion-route_4.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-route_4.entry-7XM7BVE5.js.map
