...
var StatusBar = {
  ...
  getStyle: /* @__PURE__ */ __name(function() {
...
var getBackdropValueForSheet = /* @__PURE__ */ __name((x, backdropBreakpoint) => {
...
var setCardStatusBarDark = /* @__PURE__ */ __name(() => {
  if (!win || win.innerWidth >= 768) {
    return;
  }
  StatusBar.setStyle({ style: Style.Dark });
}, "setCardStatusBarDark");
var setCardStatusBarDefault = /* @__PURE__ */ __name((defaultStyle = Style.Default) => {
  if (!win || win.innerWidth >= 768) {
    return;
  }
  StatusBar.setStyle({ style: defaultStyle });
}, "setCardStatusBarDefault");
var handleCanDismiss = /* @__PURE__ */ __name((el, animation) => __async(null, null, function* () {
...
var calculateSpringStep = /* @__PURE__ */ __name((t) => {
  return 255275e-8 * 2.71828 ** (-14.9619 * t) - 1.00255 * 2.71828 ** (-0.0380968 * t) + 1;
}, "calculateSpringStep");
var SwipeToCloseDefaults = {
  MIN_PRESENTING_SCALE: 0.915
};
var createSwipeToCloseGesture = /* @__PURE__ */ __name((el, animation, statusBarStyle, onDismiss) => {
  ...
  let lastStep = 0;
  const getScrollY = /* @__PURE__ */ __name(() => {
  ...
  const onStart = /* @__PURE__ */ __name((detail) => {
    const { deltaY } = detail;
...
var computeDuration = /* @__PURE__ */ __name((remaining, velocity) => {
  return clamp(400, remaining / Math.abs(velocity * 1.1), 500);
}, "computeDuration");
var createSheetEnterAnimation = /* @__PURE__ */ __name((opts) => {
...
}, "createSheetEnterAnimation");
var createSheetLeaveAnimation = /* @__PURE__ */ __name((opts) => {
...
}, "createSheetLeaveAnimation");
var createEnterAnimation$1 = /* @__PURE__ */ __name(() => {
...
var iosLeaveAnimation = /* @__PURE__ */ __name((baseEl, opts, duration = 500) => {
...
var mdLeaveAnimation = /* @__PURE__ */ __name((baseEl, opts) => {
...
var createSheetGesture = /* @__PURE__ */ __name((baseEl, backdropEl, wrapperEl, initialBreakpoint, backdropBreakpoint, animation, breakpoints = [], expandToScroll, getCurrentBreakpoint, onDismiss, onBreakpointChange) => {
  ...
  const enableBackdrop = /* @__PURE__ */ __name(() => {
    baseEl.style.setProperty("pointer-events", "auto");
    backdropEl.style.setProperty("pointer-events", "auto");
    baseEl.classList.remove(FOCUS_TRAP_DISABLE_CLASS);
  }, "enableBackdrop");
  const disableBackdrop = /* @__PURE__ */ __name(() => {
    baseEl.style.setProperty("pointer-events", "none");
    backdropEl.style.setProperty("pointer-events", "none");
    baseEl.classList.add(FOCUS_TRAP_DISABLE_CLASS);
  }, "disableBackdrop");
  const swapFooterPosition = /* @__PURE__ */ __name((newPosition) => {
    if (!cachedFooterEls) {
  ...
  const moveSheetToBreakpoint = /* @__PURE__ */ __name((options) => {
...
var Modal = (_a = class {
  ...
  componentWillLoad() {
    ...
    if (!((_a2 = this.htmlAttributes) === null || _a2 === void 0 ? void 0 : _a2.id)) {
      ...
      mutations.forEach((mutation) => {
        if (mutation.type === "childList" && mutation.removedNodes.length > 0) {
          const cachedParentWasRemoved = Array.from(mutation.removedNodes).some((node) => {
            ...
            const isContainedMatch = this.cachedOriginalParent ? (_b = (_a2 = node).contains) === null || _b === void 0 ? void 0 : _b.call(_a2, this.cachedOriginalParent) : false;
  ...
  cleanupParentRemovalObserver() {
    var _a2;
    (_a2 = this.parentRemovalObserver) === null || _a2 === void 0 ? void 0 : _a2.disconnect();
  ...
  render() {
    ...
    return h(Host, Object.assign({
    ...
    }, class: Object.assign({ [mode]: true, ["modal-default"]: !isCardModal && !isSheetModal, [`modal-card`]: isCardModal, [`modal-sheet`]: isSheetModal, [`modal-no-expand-scroll`]: isSheetModal && !expandToScroll, "overlay-hidden": true, [FOCUS_TRAP_DISABLE_CLASS]: focusTrap === false }, getClassMap(this.cssClass)), onIonBackdropTap: this.onBackdropTap, onIonModalDidPresent: this.onLifecycle, onIonModalWillPresent: this.onLifecycle, onIonModalWillDismiss: this.onLifecycle, onIonModalDidDismiss: this.onLifecycle, onFocus: this.onModalFocus }), h("ion-backdrop", { key: "e5eae2c14f830f75e308fcd7f4c10c86fac5b962", ref: /* @__PURE__ */ __name((el) => this.backdropEl = el, "ref"), visible: this.showBackdrop, tappable: this.backdropDismiss, part: "backdrop" }), mode === "ios" && h("div", { key: "e268f9cd310c3cf4e051b5b92524ce4fb70d005e", class: "modal-shadow" }), h("div", Object.assign({
      ...
      */
      role: "dialog"
    }, inheritedAttributes, { "aria-modal": "true", class: "modal-wrapper ion-overlay-wrapper", part: "content", ref: /* @__PURE__ */ __name((el) => this.wrapperEl = el, "ref") }), showHandle && h("button", {
      ...
      part: "handle",
      ref: /* @__PURE__ */ __name((el) => this.dragHandleEl = el, "ref")
...
@ionic/core/dist/esm/ion-modal.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-modal.entry-O5YU3CTM.js.map
