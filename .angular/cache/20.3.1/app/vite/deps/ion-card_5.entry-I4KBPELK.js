...
var Card = (_a = class {
  ...
  renderCard(mode) {
    ...
    return h(TagType, Object.assign({}, attrs, inheritedAriaAttributes, { class: "card-native", part: "native", disabled: this.disabled, onClick: /* @__PURE__ */ __name((ev) => openURL(href, ev, routerDirection, routerAnimation), "onClick") }), h("slot", null), clickable && mode === "md" && h("ion-ripple-effect", null));
  }
  render() {
...
@ionic/core/dist/esm/ion-card_5.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-card_5.entry-I4KBPELK.js.map
