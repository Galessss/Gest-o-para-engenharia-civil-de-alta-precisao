...
__name(getAnimationPosition, "getAnimationPosition");
...
__name(warnIfAnchorIsHidden, "warnIfAnchorIsHidden");
var getOffsetForMiddlePosition = /* @__PURE__ */ __name((toastHeight, wrapperHeight) => {
...
var iosLeaveAnimation = /* @__PURE__ */ __name((baseEl, opts) => {
  const baseAnimation = createAnimation();
  const wrapperAnimation = createAnimation();
  const { position, top, bottom } = opts;
  const root = getElementRoot(baseEl);
...
var createSwipeToDismissGesture = /* @__PURE__ */ __name((el, toastPosition, onDismiss) => {
  ...
  const computeStep = /* @__PURE__ */ __name((delta) => {
...
var Toast = (_a = class {
  ...
  renderButtons(buttons, side) {
    ...
    return h("div", { class: buttonGroupsClasses }, buttons.map((b) => h("button", Object.assign({}, b.htmlAttributes, { type: "button", class: buttonClass(b), tabIndex: 0, onClick: /* @__PURE__ */ __name(() => this.buttonClick(b), "onClick"), part: buttonPart(b) }), h("div", { class: "toast-button-inner" }, b.icon && h("ion-icon", { "aria-hidden": "true", icon: b.icon, slot: b.text === void 0 ? "icon-only" : void 0, class: "toast-button-icon" }), b.text), mode === "md" && h("ion-ripple-effect", { type: b.icon !== void 0 && b.text === void 0 ? "unbounded" : "bounded" }))));
  }
  /**
...
var buttonPart = /* @__PURE__ */ __name((button) => {
...
@ionic/core/dist/esm/ion-toast.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-toast.entry-AOTUFHHY.js.map
