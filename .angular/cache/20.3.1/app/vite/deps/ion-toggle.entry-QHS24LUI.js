...
var Toggle = (_a = class {
  ...
  renderToggleControl() {
    ...
    return h("div", { class: "toggle-icon", part: "track", ref: /* @__PURE__ */ __name((el) => this.toggleTrack = el, "ref") }, enableOnOffLabels && mode === "ios" && [this.renderOnOffSwitchLabels(mode, true), this.renderOnOffSwitchLabels(mode, false)], h("div", { class: "toggle-icon-wrapper" }, h("div", { class: "toggle-inner", part: "handle" }, enableOnOffLabels && mode === "md" && this.renderOnOffSwitchLabels(mode, checked))));
  }
  get hasLabel() {
  ...
  render() {
    ...
    return h(Host, { key: "21037ea2e8326f58c84becadde475f007f931924", role: "switch", "aria-checked": `${checked}`, "aria-describedby": this.getHintTextID(), "aria-invalid": this.getHintTextID() === errorTextId, onClick: this.onClick, "aria-labelledby": hasLabel ? inputLabelId : null, "aria-label": inheritedAttributes["aria-label"] || null, "aria-disabled": disabled ? "true" : null, tabindex: disabled ? void 0 : 0, onKeyDown: this.onKeyDown, class: createColorClasses(color, {
      ...
      [`toggle-${rtl}`]: true
    }) }, h("label", { key: "4d153679d118d01286f6633d1c19558a97745ff6", class: "toggle-wrapper", htmlFor: inputId }, h("input", Object.assign({ key: "0dfcd4df15b8d41bec5ff5f8912503afbb7bec53", type: "checkbox", role: "switch", "aria-checked": `${checked}`, checked, disabled, id: inputId, onFocus: /* @__PURE__ */ __name(() => this.onFocus(), "onFocus"), onBlur: /* @__PURE__ */ __name(() => this.onBlur(), "onBlur"), ref: /* @__PURE__ */ __name((focusEl) => this.focusEl = focusEl, "ref"), required }, inheritedAttributes)), h("div", { key: "ffed3a07ba2ab70e5b232e6041bc3b6b34be8331", class: {
...
var shouldToggle = /* @__PURE__ */ __name((rtl, checked, deltaX, margin) => {
  if (checked) {
...
@ionic/core/dist/esm/ion-toggle.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-toggle.entry-QHS24LUI.js.map
