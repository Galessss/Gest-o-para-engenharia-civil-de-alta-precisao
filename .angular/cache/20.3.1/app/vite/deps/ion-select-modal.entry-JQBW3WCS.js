...
var SelectModal = (_a = class {
  ...
  renderRadioOptions() {
    ...
    return h("ion-radio-group", { value: checked, onIonChange: /* @__PURE__ */ __name((ev) => this.callOptionHandler(ev), "onIonChange") }, this.options.map((option) => h("ion-item", { lines: "none", class: Object.assign({
      // TODO FW-4784
      "item-radio-checked": option.value === checked
    }, getClassMap(option.cssClass)) }, h("ion-radio", { value: option.value, disabled: option.disabled, justify: "start", labelPlacement: "end", onClick: /* @__PURE__ */ __name(() => this.closeModal(), "onClick"), onKeyUp: /* @__PURE__ */ __name((ev) => {
      if (ev.key === " ") {
        this.closeModal();
      }
    }, "onKeyUp") }, option.text))));
...
@ionic/core/dist/esm/ion-select-modal.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-select-modal.entry-JQBW3WCS.js.map
