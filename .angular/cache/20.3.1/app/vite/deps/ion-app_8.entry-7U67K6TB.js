...
import "./chunk-KFKELYPZ.js";
import "./chunk-HJNNBEFY.js";
import {
  findIonContent,
  getScrollElement,
  printIonContentErrorMsg
} from "./chunk-OHKMCRTQ.js";
import {
  ...
  componentDidLoad() {
    {
      rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-C6WeRr09-5XDSBKMO.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-pATNXEtr-KZJEGG67.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-C4KDnhxb-U3U3XV6G.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./hardware-back-button-Dhbd-23H-ITMFIX7U.js");
        ...
        if (typeof window !== "undefined") {
          import("./keyboard-ywgs5efA-2GQZHZCW.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./focus-visible-BmVRXR1y-FCAZD5ZL.js").then((module) => this.focusVisible = module.startFocusVisible());
      }));
    }
  }
  /**
...
var rIC = /* @__PURE__ */ __name((callback) => {
...
var Content = (_a3 = class {
  ...
  render() {
    ...
    } }, inheritedAttributes), h("div", { key: "6480ca7648b278abb36477b3838bccbcd4995e2a", ref: /* @__PURE__ */ __name((el2) => this.backgroundContentEl = el2, "ref"), id: "background-content", part: "background" }), fixedSlotPlacement === "before" ? h("slot", { name: "fixed" }) : null, h("div", { key: "29a23b663f5f0215bb000820c01e1814c0d55985", class: {
      "inner-scroll": true,
      "scroll-x": scrollX,
      "scroll-y": scrollY,
      overscroll: (scrollX || scrollY) && forceOverscroll
    }, ref: /* @__PURE__ */ __name((scrollEl) => this.scrollEl = scrollEl, "ref"), onScroll: this.scrollEvents ? (ev) => this.onScroll(ev) : void 0, part: "scroll" }, h("slot", { key: "0fe1bd05609a4b88ae2ce9addf5d5dc5dc1806f0" })), transitionShadow ? h("div", { class: "transition-effect" }, h("div", { class: "transition-cover" }), h("div", { class: "transition-shadow" })) : null, fixedSlotPlacement === "after" ? h("slot", { name: "fixed" }) : null);
  }
  get el() {
    return getElement(this);
  }
}, __name(_a3, "Content"), _a3);
var getParentElement = /* @__PURE__ */ __name((el) => {
  var _a9;
  if (el.parentElement) {
    return el.parentElement;
  }
  if ((_a9 = el.parentNode) === null || _a9 === void 0 ? void 0 : _a9.host) {
    return el.parentNode.host;
  }
  return null;
}, "getParentElement");
var getPageElement = /* @__PURE__ */ __name((el) => {
...
var updateScrollDetail = /* @__PURE__ */ __name((detail, el, timestamp, shouldStart) => {
...
var handleFooterFade = /* @__PURE__ */ __name((scrollEl, baseEl) => {
  readTask(() => {
...
}, __name(_a4, "Footer"), _a4);
Footer.style = {
  ios: footerIosCss,
  md: footerMdCss
};
var TRANSITION = "all 0.2s ease-in-out";
var cloneElement = /* @__PURE__ */ __name((tagName) => {
...
var createHeaderIndex = /* @__PURE__ */ __name((headerEl) => {
  if (!headerEl) {
    return;
  }
...
var handleContentScroll = /* @__PURE__ */ __name((scrollEl, scrollHeaderIndex, contentEl) => {
  readTask(() => {
    const scrollTop = scrollEl.scrollTop;
...
var setToolbarBackgroundOpacity = /* @__PURE__ */ __name((headerEl, opacity) => {
...
var handleToolbarBorderIntersection = /* @__PURE__ */ __name((ev, mainHeaderIndex, scrollTop) => {
...
var handleToolbarIntersection = /* @__PURE__ */ __name((ev, mainHeaderIndex, scrollHeaderIndex, scrollEl) => {
  writeTask(() => {
    const scrollTop = scrollEl.scrollTop;
...
var setHeaderActive = /* @__PURE__ */ __name((headerIndex, active = true) => {
...
var scaleLargeTitles = /* @__PURE__ */ __name((toolbars = [], scale = 1, transition2 = false) => {
...
var handleHeaderFade = /* @__PURE__ */ __name((scrollEl, baseEl, condenseHeader) => {
  readTask(() => {
    const scrollTop = scrollEl.scrollTop;
...
var Header = (_a5 = class {
  ...
  setupCondenseHeader(contentEl, pageEl) {
    return __async(this, null, function* () {
      ...
      const toolbarIntersection = /* @__PURE__ */ __name((ev) => {
...
var RouterOutlet = (_a6 = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./swipe-back-B2YfOHRM-CXTCLZAK.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a9;
        return (_a9 = this.ani) === null || _a9 === void 0 ? void 0 : _a9.progressStep(step);
...
@ionic/core/dist/esm/ion-app_8.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-app_8.entry-7U67K6TB.js.map
