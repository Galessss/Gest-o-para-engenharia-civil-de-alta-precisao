...
var ItemSliding = (_a3 = class {
  ...
  open(side) {
    return __async(this, null, function* () {
      var _a4;
      const item = this.item = (_a4 = this.item) !== null && _a4 !== void 0 ? _a4 : this.el.querySelector("ion-item");
      if (item === null) {
        return;
      }
  ...
  updateOptions() {
    return __async(this, null, function* () {
      ...
      for (let i = 0; i < options.length; i++) {
        ...
        const side = isEndSide((_a4 = option.side) !== null && _a4 !== void 0 ? _a4 : option.getAttribute("side")) ? "end" : "start";
        if (side === "start") {
...
}, __name(_a3, "ItemSliding"), _a3);
var swipeShouldReset = /* @__PURE__ */ __name((isResetDirection, isMovingFast, isOnResetZone) => {
...
@ionic/core/dist/esm/ion-item-option_3.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-item-option_3.entry-PHZVNPPH.js.map
