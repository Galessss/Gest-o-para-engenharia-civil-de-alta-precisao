...
var Tabs = (_a2 = class {
  ...
  setRouteId(id) {
    return __async(this, null, function* () {
      ...
      return {
        ...
        markVisible: /* @__PURE__ */ __name(() => this.tabSwitch(), "markVisible")
      };
    });
  }
  /** @internal */
  getRouteId() {
    return __async(this, null, function* () {
      var _a3;
      const tabId = (_a3 = this.selectedTab) === null || _a3 === void 0 ? void 0 : _a3.tab;
...
var getTab = /* @__PURE__ */ __name((tabs, tab) => {
...
@ionic/core/dist/esm/ion-tab_2.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-tab_2.entry-6K5YBCBG.js.map
