...
} from "./chunk-IZNJAGHE.js";
import "./chunk-HJNNBEFY.js";
import {
  caretDownSharp,
  caretUpSharp,
  chevronBack,
...
var isYearDisabled = /* @__PURE__ */ __name((refYear, minParts, maxParts) => {
...
var isDayDisabled = /* @__PURE__ */ __name((refParts, minParts, maxParts, dayValues) => {
...
var getCalendarDayState = /* @__PURE__ */ __name((locale, refParts, activeParts, todayParts, minParts, maxParts, dayValues) => {
...
var isMonthDisabled = /* @__PURE__ */ __name((refParts, { minParts, maxParts }) => {
...
var isPrevMonthDisabled = /* @__PURE__ */ __name((refParts, minParts, maxParts) => {
...
var isNextMonthDisabled = /* @__PURE__ */ __name((refParts, maxParts) => {
  const nextMonth = Object.assign(Object.assign({}, getNextMonth(refParts)), { day: null });
  return isMonthDisabled(nextMonth, {
    maxParts
  });
}, "isNextMonthDisabled");
var getHighlightStyles = /* @__PURE__ */ __name((highlightedDates, dateIsoString, el) => {
...
`, this.el);
    ...
    this.getActivePartsWithFallback = () => {
      ...
      return (_a4 = this.getActivePart()) !== null && _a4 !== void 0 ? _a4 : defaultParts;
    };
    this.getActivePart = () => {
    ...
    this.initializeKeyboardListeners = () => {
      ...
      const checkCalendarBodyFocus = /* @__PURE__ */ __name((ev) => {
        var _a4;
        const record = ev[0];
        if (((_a4 = record.oldValue) === null || _a4 === void 0 ? void 0 : _a4.includes("ion-focused")) || !calendarBodyRef.classList.contains("ion-focused")) {
          return;
        }
    ...
    this.initializeCalendarListener = () => {
      ...
      writeTask(() => {
        ...
        const getChangedMonth = /* @__PURE__ */ __name((parts) => {
        ...
        const updateActiveMonth = /* @__PURE__ */ __name(() => {
  ...
  componentDidLoad() {
    ...
    const visibleCallback = /* @__PURE__ */ __name((entries) => {
      const ev = entries[0];
    ...
    const hiddenCallback = /* @__PURE__ */ __name((entries) => {
      const ev = entries[0];
      if (ev.isIntersecting) {
        return;
      }
  ...
  renderFooter() {
    ...
    const clearButtonClick = /* @__PURE__ */ __name(() => {
      this.reset();
      this.setValue(void 0);
    }, "clearButtonClick");
    ...
    } }, h("slot", { name: "buttons" }, h("ion-buttons", null, showDefaultButtons && h("ion-button", { id: "cancel-button", color: this.color, onClick: /* @__PURE__ */ __name(() => this.cancel(true), "onClick"), disabled: isButtonDisabled }, this.cancelText), h("div", { class: "datetime-action-buttons-container" }, showClearButton && h("ion-button", { id: "clear-button", color: this.color, onClick: /* @__PURE__ */ __name(() => clearButtonClick(), "onClick"), disabled: isButtonDisabled }, this.clearText), showDefaultButtons && h("ion-button", { id: "confirm-button", color: this.color, onClick: /* @__PURE__ */ __name(() => this.confirm(true), "onClick"), disabled: isButtonDisabled }, this.doneText)))))));
  }
  /**
  ...
  renderCombinedDatePickerColumn() {
    ...
    return h("ion-picker-column", { "aria-label": "Select a date", class: "date-column", color: this.color, disabled, value: todayString, onIonChange: /* @__PURE__ */ __name((ev) => {
      const { value } = ev.detail;
      const findPart = parts.find(({ month, day, year }) => value === `${year}-${month}-${day}`);
      this.setWorkingParts(Object.assign(Object.assign({}, workingParts), findPart));
      this.setActiveParts(Object.assign(Object.assign({}, activePart), findPart));
      ev.stopPropagation();
    }, "onIonChange") }, items.map((item) => h("ion-picker-column-option", { part: item.value === todayString ? `${WHEEL_ITEM_PART} ${WHEEL_ITEM_ACTIVE_PART}` : WHEEL_ITEM_PART, key: item.value, disabled: item.disabled, value: item.value }, item.text)));
  }
  ...
  renderDayPickerColumn(days) {
    ...
    const activePart = this.getActivePartsWithFallback();
    const pickerColumnValue = (_a4 = workingParts.day !== null ? workingParts.day : this.defaultParts.day) !== null && _a4 !== void 0 ? _a4 : void 0;
    return h("ion-picker-column", { "aria-label": "Select a day", class: "day-column", color: this.color, disabled, value: pickerColumnValue, onIonChange: /* @__PURE__ */ __name((ev) => {
      ...
      ev.stopPropagation();
    }, "onIonChange") }, days.map((day) => h("ion-picker-column-option", { part: day.value === pickerColumnValue ? `${WHEEL_ITEM_PART} ${WHEEL_ITEM_ACTIVE_PART}` : WHEEL_ITEM_PART, key: day.value, disabled: day.disabled, value: day.value }, day.text)));
  }
  renderMonthPickerColumn(months) {
    ...
    const { disabled, workingParts } = this;
    const activePart = this.getActivePartsWithFallback();
    return h("ion-picker-column", { "aria-label": "Select a month", class: "month-column", color: this.color, disabled, value: workingParts.month, onIonChange: /* @__PURE__ */ __name((ev) => {
      this.setWorkingParts(Object.assign(Object.assign({}, workingParts), { month: ev.detail.value }));
      this.setActiveParts(Object.assign(Object.assign({}, activePart), { month: ev.detail.value }));
      ev.stopPropagation();
    }, "onIonChange") }, months.map((month) => h("ion-picker-column-option", { part: month.value === workingParts.month ? `${WHEEL_ITEM_PART} ${WHEEL_ITEM_ACTIVE_PART}` : WHEEL_ITEM_PART, key: month.value, disabled: month.disabled, value: month.value }, month.text)));
  }
  renderYearPickerColumn(years) {
    ...
    const { disabled, workingParts } = this;
    const activePart = this.getActivePartsWithFallback();
    return h("ion-picker-column", { "aria-label": "Select a year", class: "year-column", color: this.color, disabled, value: workingParts.year, onIonChange: /* @__PURE__ */ __name((ev) => {
      this.setWorkingParts(Object.assign(Object.assign({}, workingParts), { year: ev.detail.value }));
      this.setActiveParts(Object.assign(Object.assign({}, activePart), { year: ev.detail.value }));
      ev.stopPropagation();
    }, "onIonChange") }, years.map((year) => h("ion-picker-column-option", { part: year.value === workingParts.year ? `${WHEEL_ITEM_PART} ${WHEEL_ITEM_ACTIVE_PART}` : WHEEL_ITEM_PART, key: year.value, disabled: year.disabled, value: year.value }, year.text)));
  }
  ...
  renderHourPickerColumn(hoursData) {
    ...
    if (hoursData.length === 0)
      return [];
    const activePart = this.getActivePartsWithFallback();
    return h("ion-picker-column", { "aria-label": "Select an hour", color: this.color, disabled, value: activePart.hour, numericInput: true, onIonChange: /* @__PURE__ */ __name((ev) => {
      this.setWorkingParts(Object.assign(Object.assign({}, workingParts), { hour: ev.detail.value }));
      this.setActiveParts(Object.assign(Object.assign({}, this.getActivePartsWithFallback()), { hour: ev.detail.value }));
      ev.stopPropagation();
    }, "onIonChange") }, hoursData.map((hour) => h("ion-picker-column-option", { part: hour.value === activePart.hour ? `${WHEEL_ITEM_PART} ${WHEEL_ITEM_ACTIVE_PART}` : WHEEL_ITEM_PART, key: hour.value, disabled: hour.disabled, value: hour.value }, hour.text)));
  }
  renderMinutePickerColumn(minutesData) {
    ...
    if (minutesData.length === 0)
      return [];
    const activePart = this.getActivePartsWithFallback();
    return h("ion-picker-column", { "aria-label": "Select a minute", color: this.color, disabled, value: activePart.minute, numericInput: true, onIonChange: /* @__PURE__ */ __name((ev) => {
      this.setWorkingParts(Object.assign(Object.assign({}, workingParts), { minute: ev.detail.value }));
      this.setActiveParts(Object.assign(Object.assign({}, this.getActivePartsWithFallback()), { minute: ev.detail.value }));
      ev.stopPropagation();
    }, "onIonChange") }, minutesData.map((minute) => h("ion-picker-column-option", { part: minute.value === activePart.minute ? `${WHEEL_ITEM_PART} ${WHEEL_ITEM_ACTIVE_PART}` : WHEEL_ITEM_PART, key: minute.value, disabled: minute.disabled, value: minute.value }, minute.text)));
  }
  renderDayPeriodPickerColumn(dayPeriodData) {
    ...
    return h("ion-picker-column", { "aria-label": "Select a day period", style: isDayPeriodRTL ? { order: "-1" } : {}, color: this.color, disabled, value: activePart.ampm, onIonChange: /* @__PURE__ */ __name((ev) => {
      ...
      ev.stopPropagation();
    }, "onIonChange") }, dayPeriodData.map((dayPeriod) => h("ion-picker-column-option", { part: dayPeriod.value === activePart.ampm ? `${WHEEL_ITEM_PART} ${WHEEL_ITEM_ACTIVE_PART}` : WHEEL_ITEM_PART, key: dayPeriod.value, disabled: dayPeriod.disabled, value: dayPeriod.value }, dayPeriod.text)));
  }
  ...
  renderCalendarHeader(mode) {
    ...
    return h("div", { class: "calendar-header" }, h("div", { class: "calendar-action-buttons" }, h("div", { class: "calendar-month-year" }, h("button", { class: {
      ...
      "ion-focusable": true
    }, part: "month-year-button", disabled, "aria-label": this.showMonthAndYear ? "Hide year picker" : "Show year picker", onClick: /* @__PURE__ */ __name(() => this.toggleMonthAndYearView(), "onClick") }, h("span", { id: "toggle-wrapper" }, getMonthAndYear(this.locale, this.workingParts), h("ion-icon", { "aria-hidden": "true", icon: this.showMonthAndYear ? expandedIcon : collapsedIcon, lazy: false, flipRtl: true })), mode === "md" && h("ion-ripple-effect", null))), h("div", { class: "calendar-next-prev" }, h("ion-buttons", null, h("ion-button", { "aria-label": "Previous month", disabled: prevMonthDisabled, onClick: /* @__PURE__ */ __name(() => this.prevMonth(), "onClick") }, h("ion-icon", { dir: hostDir, "aria-hidden": "true", slot: "icon-only", icon: chevronBack, lazy: false, flipRtl: true })), h("ion-button", { "aria-label": "Next month", disabled: nextMonthDisabled, onClick: /* @__PURE__ */ __name(() => this.nextMonth(), "onClick") }, h("ion-icon", { dir: hostDir, "aria-hidden": "true", slot: "icon-only", icon: chevronForward, lazy: false, flipRtl: true }))))), h("div", { class: "calendar-days-of-week", "aria-hidden": "true" }, getDaysOfWeek(this.locale, mode, this.firstDayOfWeek % 7).map((d) => {
  ...
  renderCalendarBody() {
    return h("div", { class: "calendar-body ion-focusable", ref: /* @__PURE__ */ __name((el) => this.calendarBodyRef = el, "ref"), tabindex: "0" }, generateMonths(this.workingParts, this.forceRenderDate).map(({ month, year }) => {
  ...
  renderTimeOverlay() {
    ...
    return [
      ...
      }, part: `time-button${isTimePopoverOpen ? " active" : ""}`, "aria-expanded": "false", "aria-haspopup": "true", disabled, onClick: /* @__PURE__ */ __name((ev) => __async(this, null, function* () {
      ...
      }), "onClick") }, getLocalizedTime(locale, activePart, computedHourCycle, formatOptions === null || formatOptions === void 0 ? void 0 : formatOptions.time)),
      h("ion-popover", {
        alignment: "center",
        translucent: true,
        overlayIndex: 1,
        arrow: false,
        onWillPresent: /* @__PURE__ */ __name((ev) => {
        ...
        keyboardEvents: true,
        ref: /* @__PURE__ */ __name((el) => this.popoverRef = el, "ref")
  ...
  getHeaderSelectedDateText() {
    ...
    if (multiple && isArray && activeParts.length !== 1) {
      ...
      headerText = getLocalizedDateTime(this.locale, this.getActivePartsWithFallback(), (_a4 = formatOptions === null || formatOptions === void 0 ? void 0 : formatOptions.date) !== null && _a4 !== void 0 ? _a4 : { weekday: "short", month: "short", day: "numeric" });
    }
    return headerText;
  }
  ...
  render() {
    ...
    })) }, h("div", { key: "859e9354a12bfa58ac3f964c2e66839f17071c00", class: "intersection-tracker", ref: /* @__PURE__ */ __name((el2) => this.intersectionTrackerRef = el2, "ref") }), this.renderDatetime(mode));
  }
  get el() {
...
var iosEnterAnimation = /* @__PURE__ */ __name((baseEl) => {
...
var iosLeaveAnimation = /* @__PURE__ */ __name((baseEl) => {
  const baseAnimation = createAnimation();
  const backdropAnimation = createAnimation();
  const wrapperAnimation = createAnimation();
...
var Picker = (_a2 = class {
  ...
  componentWillLoad() {
    var _a4;
    if (!((_a4 = this.htmlAttributes) === null || _a4 === void 0 ? void 0 : _a4.id)) {
...
}, __name(_a2, "Picker"), _a2);
var buttonWrapperClass = /* @__PURE__ */ __name((button) => {
  return {
    [`picker-toolbar-${button.role}`]: button.role !== void 0,
    "picker-toolbar-button": true
  };
}, "buttonWrapperClass");
var buttonClass = /* @__PURE__ */ __name((button) => {
...
var PickerColumnCmp = (_a3 = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./index-CfgBF1SE-ONF5FXM6.js")).createGesture({
        el: this.el,
        gestureName: "picker-swipe",
        gesturePriority: 100,
        threshold: 0,
        passive: false,
        onStart: /* @__PURE__ */ __name((ev) => this.onStart(ev), "onStart"),
        onMove: /* @__PURE__ */ __name((ev) => this.onMove(ev), "onMove"),
        onEnd: /* @__PURE__ */ __name((ev) => this.onEnd(ev), "onEnd")
      });
      this.gesture.enable();
  ...
  refresh(forceRefresh, animated) {
    ...
    const selectedIndex = clamp(min, (_a4 = this.col.selectedIndex) !== null && _a4 !== void 0 ? _a4 : 0, max);
  ...
  render() {
    ...
    } }, col.prefix && h("div", { key: "9f0634890e66fd4ae74f826d1eea3431de121393", class: "picker-prefix", style: { width: col.prefixWidth } }, col.prefix), h("div", { key: "337e996e5be91af16446085fe22436f213b771eb", class: "picker-opts", style: { maxWidth: col.optionsWidth }, ref: /* @__PURE__ */ __name((el) => this.optsEl = el, "ref") }, col.options.map((o, index) => h("button", { "aria-label": o.ariaLabel, class: { "picker-opt": true, "picker-opt-disabled": !!o.disabled }, "opt-index": index }, o.text))), col.suffix && h("div", { key: "d69a132599d78d9e5107f12228978cfce4e43098", class: "picker-suffix", style: { width: col.suffixWidth } }, col.suffix));
  }
  get el() {
    return getElement(this);
  }
...
}, __name(_a3, "PickerColumnCmp"), _a3);
...
@ionic/core/dist/esm/ion-datetime_3.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-datetime_3.entry-SYMSG4HQ.js.map
