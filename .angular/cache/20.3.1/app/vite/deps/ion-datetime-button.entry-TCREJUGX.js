...
var DatetimeButton = (_a = class {
  constructor(hostRef) {
    ...
    this.setDateTimeText = () => {
      ...
      switch (datetimePresentation) {
        case "date-time":
        case "time-date":
          const dateText = getLocalizedDateTime(locale, firstParsedDatetime, (_a2 = formatOptions === null || formatOptions === void 0 ? void 0 : formatOptions.date) !== null && _a2 !== void 0 ? _a2 : { month: "short", day: "numeric", year: "numeric" });
  ...
  render() {
    ...
    }) }, dateText && h("button", { key: "08ecb62da0fcbf7466a1f2403276712a3ff17fbc", class: "ion-activatable", id: "date-button", "aria-expanded": datetimeActive ? "true" : "false", onClick: this.handleDateClick, disabled, part: "native", ref: /* @__PURE__ */ __name((el) => this.dateTargetEl = el, "ref") }, h("slot", { key: "1c04853d4d23c0f1a594602bde44511c98355644", name: "date-target" }, dateText), mode === "md" && h("ion-ripple-effect", { key: "5fc566cd4bc885bcf983ce99e3dc65d7f485bf9b" })), timeText && h("button", { key: "c9c5c34ac338badf8659da22bea5829d62c51169", class: "ion-activatable", id: "time-button", "aria-expanded": datetimeActive ? "true" : "false", onClick: this.handleTimeClick, disabled, part: "native", ref: /* @__PURE__ */ __name((el) => this.timeTargetEl = el, "ref") }, h("slot", { key: "147a9d2069dbf737f6fc64787823d6d5af5aa653", name: "time-target" }, timeText), mode === "md" && h("ion-ripple-effect", { key: "70a5e25b75ed90ac6bba003468435f67aa9d8f0a" })));
  }
  get el() {
    return getElement(this);
  }
}, __name(_a, "DatetimeButton"), _a);
...
@ionic/core/dist/esm/ion-datetime-button.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-datetime-button.entry-TCREJUGX.js.map
