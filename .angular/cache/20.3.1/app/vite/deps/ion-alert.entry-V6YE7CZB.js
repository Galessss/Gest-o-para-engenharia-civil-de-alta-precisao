...
} from "./chunk-C275NHQL.js";
import "./chunk-FTYOYGL7.js";
import {
...
var mdEnterAnimation = /* @__PURE__ */ __name((baseEl) => {
  const baseAnimation = createAnimation();
  const backdropAnimation = createAnimation();
  const wrapperAnimation = createAnimation();
  backdropAnimation.addElement(baseEl.querySelector("ion-backdrop")).fromTo("opacity", 0.01, "var(--backdrop-opacity)").beforeStyles({
...
var Alert = (_a = class {
  ...
  onKeydown(ev) {
    ...
    if (ev.target.classList.contains("alert-wrapper")) {
      if (ev.key === "Tab" && ev.shiftKey) {
        ev.preventDefault();
        const lastChildBtn = (_a2 = this.wrapperEl) === null || _a2 === void 0 ? void 0 : _a2.querySelector(".alert-button:last-child");
        lastChildBtn.focus();
        return;
      }
    }
    ...
    return __async(this, null, function* () {
      ...
      yield present(this, "alertEnter", iosEnterAnimation, mdEnterAnimation).then(() => {
        ...
        if (this.buttons.length === 1 && this.inputs.length === 0) {
          const queryBtn = (_a2 = this.wrapperEl) === null || _a2 === void 0 ? void 0 : _a2.querySelector(".alert-button");
          queryBtn.focus();
        } else {
  ...
  renderRadio() {
    ...
    return h("div", { class: "alert-radio-group", role: "radiogroup", "aria-activedescendant": this.activeId }, inputs.map((i) => h("button", { type: "button", onClick: /* @__PURE__ */ __name(() => this.rbClick(i), "onClick"), "aria-checked": `${i.checked}`, disabled: i.disabled, id: i.id, tabIndex: i.tabindex, class: Object.assign(Object.assign({}, getClassMap(i.cssClass)), { "alert-radio-button": true, "alert-tappable": true, "alert-radio": true, "ion-focusable": true, "alert-radio-button-disabled": i.disabled || false }), role: "radio" }, h("div", { class: "alert-button-inner" }, h("div", { class: "alert-radio-icon" }, h("div", { class: "alert-radio-inner" })), h("div", { class: "alert-radio-label" }, i.label)))));
  }
  renderInput() {
    const inputs = this.processedInputs;
    if (inputs.length === 0) {
    ...
    return h("div", { class: "alert-input-group" }, inputs.map((i) => {
      var _a2, _b, _c, _d;
      if (i.type === "textarea") {
        return h("div", { class: "alert-input-wrapper" }, h("textarea", Object.assign({ placeholder: i.placeholder, value: i.value, id: i.id, tabIndex: i.tabindex }, i.attributes, { disabled: (_b = (_a2 = i.attributes) === null || _a2 === void 0 ? void 0 : _a2.disabled) !== null && _b !== void 0 ? _b : i.disabled, class: inputClass(i), onInput: /* @__PURE__ */ __name((e) => {
          var _a3;
  ...
  renderAlertButtons() {
    ...
    return h("div", { class: alertButtonGroupClass }, buttons.map((button) => h("button", Object.assign({}, button.htmlAttributes, { type: "button", id: button.id, class: buttonClass(button), tabIndex: 0, onClick: /* @__PURE__ */ __name(() => this.buttonClick(button), "onClick") }), h("span", { class: "alert-button-inner" }, button.text), mode === "md" && h("ion-ripple-effect", null))));
  }
...
@ionic/core/dist/esm/ion-alert.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-alert.entry-V6YE7CZB.js.map
