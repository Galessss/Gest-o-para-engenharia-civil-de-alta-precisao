...
var getRefresherAnimationType = /* @__PURE__ */ __name((contentEl) => {
  const previousSibling = contentEl.previousElementSibling;
  const hasHeader = previousSibling !== null && previousSibling.tagName === "ION-HEADER";
  return hasHeader ? "translate" : "scale";
}, "getRefresherAnimationType");
var createPullingAnimation = /* @__PURE__ */ __name((type, pullingSpinner, refresherEl) => {
  return type === "scale" ? createScaleAnimation(pullingSpinner, refresherEl) : createTranslateAnimation(pullingSpinner, refresherEl);
}, "createPullingAnimation");
var createBaseAnimation = /* @__PURE__ */ __name((pullingRefresherIcon) => {
...
var createTranslateAnimation = /* @__PURE__ */ __name((pullingRefresherIcon, refresherEl) => {
  const height = refresherEl.clientHeight;
  const spinnerAnimation = createAnimation().addElement(pullingRefresherIcon).keyframes([
...
var createSnapBackAnimation = /* @__PURE__ */ __name((pullingRefresherIcon) => {
...
var setSpinnerOpacity = /* @__PURE__ */ __name((spinner, opacity) => {
  spinner.style.setProperty("opacity", opacity.toString());
}, "setSpinnerOpacity");
var handleScrollWhilePulling = /* @__PURE__ */ __name((ticks, numTicks, pullAmount) => {
  const max = 1;
  writeTask(() => {
    ticks.forEach((el, i) => {
...
var handleScrollWhileRefreshing = /* @__PURE__ */ __name((spinner, lastVelocityY) => {
  writeTask(() => {
    spinner.style.setProperty("--refreshing-rotation-duration", lastVelocityY >= 1 ? "0.5s" : "2s");
    spinner.style.setProperty("opacity", "1");
  });
}, "handleScrollWhileRefreshing");
var translateElement = /* @__PURE__ */ __name((el, value, duration = 200) => {
  if (!el) {
...
var supportsRubberBandScrolling = /* @__PURE__ */ __name(() => {
...
var shouldUseNativeRefresher = /* @__PURE__ */ __name((referenceEl, mode) => __async(null, null, function* () {
...
var Refresher = (_a = class {
  ...
  setupMDNativeRefresher(contentEl, pullingSpinner, refreshingSpinner) {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./index-CfgBF1SE-ONF5FXM6.js")).createGesture({
        ...
        direction: "y",
        threshold: 5,
        canStart: /* @__PURE__ */ __name(() => this.state !== 8 && this.state !== 32 && this.scrollEl.scrollTop === 0, "canStart"),
        onStart: /* @__PURE__ */ __name((ev) => {
          this.progress = 0;
      ...
      componentOnReady(contentEl, () => __async(this, null, function* () {
        ...
        if (yield shouldUseNativeRefresher(this.el, getIonMode(this))) {
          ...
          this.gesture = (yield import("./index-CfgBF1SE-ONF5FXM6.js")).createGesture({
            ...
            threshold: 20,
            passive: false,
            canStart: /* @__PURE__ */ __name(() => this.canStart(), "canStart"),
            onStart: /* @__PURE__ */ __name(() => this.onStart(), "onStart"),
            onMove: /* @__PURE__ */ __name((ev) => this.onMove(ev), "onMove"),
            onEnd: /* @__PURE__ */ __name(() => this.onEnd(), "onEnd")
          });
          this.disabledChanged();
        }
      }));
  ...
  close(state, delay) {
    setTimeout(() => {
      ...
      if (this.contentFullscreen && this.backgroundContentEl) {
        (_a3 = this.backgroundContentEl) === null || _a3 === void 0 ? void 0 : _a3.style.removeProperty("--offset-top");
      }
    }, 600);
    this.state = state;
...
}, __name(_a, "Refresher"), _a);
Refresher.style = {
  ios: refresherIosCss,
  md: refresherMdCss
};
var _a2;
var RefresherContent = (_a2 = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
...
}, __name(_a2, "RefresherContent"), _a2);
export {
...
@ionic/core/dist/esm/ion-refresher_2.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-refresher_2.entry-3VQBLDTS.js.map
