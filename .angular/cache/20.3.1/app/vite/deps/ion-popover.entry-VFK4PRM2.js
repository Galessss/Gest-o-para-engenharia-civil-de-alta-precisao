...
var getArrowDimensions = /* @__PURE__ */ __name((arrowEl) => {
  if (!arrowEl) {
...
var getPopoverDimensions = /* @__PURE__ */ __name((size, contentEl, triggerEl) => {
...
var configureDismissInteraction = /* @__PURE__ */ __name((triggerEl, triggerAction, popoverEl, parentPopoverEl) => {
...
var configureTriggerInteraction = /* @__PURE__ */ __name((triggerEl, triggerAction, popoverEl) => {
  ...
  switch (triggerAction) {
    case "hover":
      ...
      triggerCallbacks = [
        {
          eventName: "mouseenter",
          callback: /* @__PURE__ */ __name((ev) => __async(null, null, function* () {
            ev.stopPropagation();
            if (hoverTimeout) {
        ...
        },
        {
           ...
           */
          eventName: "click",
          callback: /* @__PURE__ */ __name((ev) => ev.stopPropagation(), "callback")
        },
        {
          eventName: "ionPopoverActivateTrigger",
          callback: /* @__PURE__ */ __name((ev) => popoverEl.presentFromTrigger(ev, true), "callback")
        }
      ];
      break;
    case "context-menu":
      ...
      triggerCallbacks = [
        {
           ...
           */
          eventName: "click",
          callback: /* @__PURE__ */ __name((ev) => popoverEl.presentFromTrigger(ev), "callback")
        },
        {
          eventName: "ionPopoverActivateTrigger",
          callback: /* @__PURE__ */ __name((ev) => popoverEl.presentFromTrigger(ev, true), "callback")
...
var getIndexOfItem = /* @__PURE__ */ __name((items, item) => {
  if (!item || item.tagName !== "ION-ITEM") {
    return -1;
  }
  return items.findIndex((el) => el === item);
}, "getIndexOfItem");
var getNextItem = /* @__PURE__ */ __name((items, currentItem) => {
  const currentItemIndex = getIndexOfItem(items, currentItem);
  return items[currentItemIndex + 1];
}, "getNextItem");
var getPrevItem = /* @__PURE__ */ __name((items, currentItem) => {
  const currentItemIndex = getIndexOfItem(items, currentItem);
  return items[currentItemIndex - 1];
}, "getPrevItem");
var focusItem = /* @__PURE__ */ __name((item) => {
...
var getPopoverPosition = /* @__PURE__ */ __name((isRTL, contentWidth, contentHeight, arrowWidth, arrowHeight, reference, side, align, defaultPosition, triggerEl, event) => {
  var _a2;
...
var calculatePopoverOrigin = /* @__PURE__ */ __name((side, align, isRTL) => {
  switch (side) {
    case "top":
...
var getOriginXAlignment = /* @__PURE__ */ __name((align) => {
  switch (align) {
    case "start":
      return "left";
    case "center":
...
var getOriginYAlignment = /* @__PURE__ */ __name((align) => {
  switch (align) {
    case "start":
      return "top";
    case "center":
...
var calculateArrowPosition = /* @__PURE__ */ __name((side, arrowWidth, arrowHeight, top, left, contentWidth, contentHeight, isRTL) => {
  const leftPosition = {
...
var calculatePopoverSide = /* @__PURE__ */ __name((side, triggerBoundingBox, contentWidth, contentHeight, arrowWidth, arrowHeight, isRTL) => {
  const sideLeft = {
    top: triggerBoundingBox.top,
...
var calculatePopoverAlign = /* @__PURE__ */ __name((align, side, triggerBoundingBox, contentWidth, contentHeight) => {
  switch (align) {
    case "center":
...
var calculatePopoverEndAlign = /* @__PURE__ */ __name((side, triggerBoundingBox, contentWidth, contentHeight) => {
  switch (side) {
    case "start":
    case "end":
    case "left":
...
}, "calculatePopoverEndAlign");
var calculatePopoverCenterAlign = /* @__PURE__ */ __name((side, triggerBoundingBox, contentWidth, contentHeight) => {
  switch (side) {
    case "start":
    case "end":
    case "left":
...
var calculateWindowAdjustment = /* @__PURE__ */ __name((side, coordTop, coordLeft, bodyPadding, bodyWidth, bodyHeight, contentWidth, contentHeight, safeAreaMargin, contentOriginX, contentOriginY, triggerCoordinates, coordArrowTop = 0, coordArrowLeft = 0, arrowHeight = 0) => {
...
var shouldShowArrow = /* @__PURE__ */ __name((side, didAdjustBounds = false, ev, trigger) => {
  if (!ev && !trigger) {
    return false;
  }
...
var iosEnterAnimation = /* @__PURE__ */ __name((baseEl, opts) => {
  var _a2;
...
var mdEnterAnimation = /* @__PURE__ */ __name((baseEl, opts) => {
  var _a2;
  const { event: ev, size, trigger, reference, side, align } = opts;
  const doc = baseEl.ownerDocument;
  const isRTL = doc.dir === "rtl";
...
var mdLeaveAnimation = /* @__PURE__ */ __name((baseEl) => {
  const root = getElementRoot(baseEl);
  const contentEl = root.querySelector(".popover-content");
  const baseAnimation = createAnimation();
  const backdropAnimation = createAnimation();
...
var Popover = (_a = class {
  ...
  componentWillLoad() {
    var _a2, _b;
    const { el } = this;
    const popoverId = (_b = (_a2 = this.htmlAttributes) === null || _a2 === void 0 ? void 0 : _a2.id) !== null && _b !== void 0 ? _b : setOverlayId(el);
...
@ionic/core/dist/esm/ion-popover.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-popover.entry-VFK4PRM2.js.map
