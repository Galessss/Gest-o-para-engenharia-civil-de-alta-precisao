...
var Menu = (_a = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./index-CfgBF1SE-ONF5FXM6.js")).createGesture({
        ...
        threshold: 10,
        blurOnStart: true,
        canStart: /* @__PURE__ */ __name((ev) => this.canStart(ev), "canStart"),
        onWillStart: /* @__PURE__ */ __name(() => this.onWillStart(), "onWillStart"),
  ...
  afterAnimation(isOpen, role) {
    ...
    if (isOpen) {
      ...
      const focusedMenu = (_a4 = document.activeElement) === null || _a4 === void 0 ? void 0 : _a4.closest("ion-menu");
  ...
  render() {
    ...
    } }, h("div", { key: "3f5f70acd4d3ed6bb445122f4f01d73db738a75f", class: "menu-inner", part: "container", ref: /* @__PURE__ */ __name((el2) => this.menuInnerEl = el2, "ref") }, h("slot", { key: "3161326c9330e7f7441299c428b87a91b31a83e9" })), h("ion-backdrop", { key: "917b50f38489bdf03d0c642af8b4e4e172c7dc4c", ref: /* @__PURE__ */ __name((el2) => this.backdropEl = el2, "ref"), class: "menu-backdrop", tappable: false, stopPropagation: false, part: "backdrop" }));
  }
  get el() {
...
var computeDelta = /* @__PURE__ */ __name((deltaX, isOpen, isEndSide2) => {
  return Math.max(0, isOpen !== isEndSide2 ? -deltaX : deltaX);
}, "computeDelta");
var checkEdgeSide = /* @__PURE__ */ __name((win, posX, isEndSide2, maxEdgeStart) => {
  if (isEndSide2) {
...
var updateVisibility = /* @__PURE__ */ __name((menu) => __async(null, null, function* () {
...
@ionic/core/dist/esm/ion-menu_3.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-menu_3.entry-FS2UEVVD.js.map
