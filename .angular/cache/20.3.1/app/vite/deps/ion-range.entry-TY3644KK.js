...
var Range = (_a = class {
  constructor(hostRef) {
    ...
    this.onKnobBlur = () => {
      setTimeout(() => {
        var _a2;
        const activeElement = (_a2 = this.el.shadowRoot) === null || _a2 === void 0 ? void 0 : _a2.activeElement;
  ...
  connectedCallback() {
    ...
    this.contentEl = (_a2 = ionContent === null || ionContent === void 0 ? void 0 : ionContent.querySelector(".ion-content-scroll-host")) !== null && _a2 !== void 0 ? _a2 : ionContent;
  }
  ...
  onEnd(detail) {
    ...
    const currentX = (_a2 = detail.currentX) !== null && _a2 !== void 0 ? _a2 : detail.clientX;
  ...
  renderRangeSlider() {
    ...
    const tickStyle = /* @__PURE__ */ __name((tick) => {
      return {
        [start]: tick[start]
      };
    }, "tickStyle");
    ...
    return h("div", {
      class: "range-slider",
      ref: /* @__PURE__ */ __name((rangeEl) => this.rangeSlider = rangeEl, "ref"),
      /**
       ...
       */
      onPointerUp: /* @__PURE__ */ __name((ev) => {
        if (this.pressedKnob === void 0) {
          this.onStart();
          this.onEnd(ev);
        }
...
var renderKnob = /* @__PURE__ */ __name((rtl, { knob, value, ratio, min, max, disabled, pressed, pin, handleKeyboard, pinFormatter, inheritedAttributes, onKnobFocus, onKnobBlur }) => {
  const start = rtl ? "right" : "left";
  const knobStyle = /* @__PURE__ */ __name(() => {
    const style = {};
    style[start] = `${ratio * 100}%`;
    return style;
  }, "knobStyle");
  const ariaLabel = inheritedAttributes["aria-label"];
  return h("div", { onKeyDown: /* @__PURE__ */ __name((ev) => {
    const key = ev.key;
  ...
  }, "onKeyDown"), onFocus: /* @__PURE__ */ __name(() => onKnobFocus(knob), "onFocus"), onBlur: onKnobBlur, class: {
...
var ratioToValue = /* @__PURE__ */ __name((ratio, min, max, step) => {
...
var valueToRatio = /* @__PURE__ */ __name((value, min, max) => {
...
@ionic/core/dist/esm/ion-range.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-range.entry-TY3644KK.js.map
