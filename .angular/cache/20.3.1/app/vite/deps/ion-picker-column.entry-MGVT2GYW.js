...
var PickerColumn = (_a = class {
  constructor(hostRef) {
      ...
      const scrollCallback = /* @__PURE__ */ __name(() => {
        raf(() => {
          ...
          if (this.updateValueTextOnScroll) {
            (_a2 = this.assistiveFocusable) === null || _a2 === void 0 ? void 0 : _a2.setAttribute("aria-valuetext", this.getOptionValueText(newActiveElement));
          }
          timeout = setTimeout(() => {
            this.isScrolling = false;
    ...
    this.getOptionValueText = (el) => {
      var _a2;
      return el ? (_a2 = el.getAttribute("aria-label")) !== null && _a2 !== void 0 ? _a2 : el.innerText : "";
    };
    this.renderAssistiveFocusable = () => {
      const { activeItem } = this;
      const valueText = this.getOptionValueText(activeItem);
      return h("div", { ref: /* @__PURE__ */ __name((el) => this.assistiveFocusable = el, "ref"), class: "assistive-focusable", role: "slider", tabindex: this.disabled ? void 0 : 0, "aria-label": this.ariaLabel, "aria-valuemin": 0, "aria-valuemax": 0, "aria-valuenow": 0, "aria-valuetext": valueText, "aria-orientation": "vertical", onKeyDown: /* @__PURE__ */ __name((ev) => this.onKeyDown(ev), "onKeyDown") });
    };
  }
  ...
  connectedCallback() {
    var _a2;
    this.ariaLabel = (_a2 = this.el.getAttribute("aria-label")) !== null && _a2 !== void 0 ? _a2 : "Select a value";
  }
  get activeItem() {
    const { value } = this;
...
@ionic/core/dist/esm/ion-picker-column.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-picker-column.entry-MGVT2GYW.js.map
