import {
  compareOptions,
  isOptionSelected
} from "./chunk-FC7U4PBR.js";
import {
  createNotchController
} from "./chunk-5FRLDOZX.js";
import {
  watchForOptions
} from "./chunk-YAA6TTDC.js";
import {
  isRTL
...
var Select = (_a = class {
  ...
  open(event) {
    return __async(this, null, function* () {
      ...
      const scrollSelectedIntoView = /* @__PURE__ */ __name(() => {
      ...
      if (this.interface === "modal") {
        ...
        const scrollAfterRender = /* @__PURE__ */ __name(() => {
  ...
  createOverlaySelectOptions(data, selectValue) {
    const popoverOptions = data.map((option) => {
      ...
      return {
        ...
        checked: isOptionSelected(selectValue, value, this.compareWith),
        disabled: option.disabled,
        handler: /* @__PURE__ */ __name((selected) => {
  ...
  openAlert() {
    return __async(this, null, function* () {
      ...
      const alertOpts = Object.assign(Object.assign({ mode }, interfaceOptions), { header: interfaceOptions.header ? interfaceOptions.header : this.labelText, inputs: this.createAlertInputs(this.childOpts, inputType, this.value), buttons: [
        ...
        {
          text: this.okText,
          handler: /* @__PURE__ */ __name((selectedValues) => {
  ...
  componentDidRender() {
    var _a4;
    (_a4 = this.notchController) === null || _a4 === void 0 ? void 0 : _a4.calculateNotchWidth();
  }
  /**
  ...
  renderLabelContainer() {
    ...
    if (hasOutlineFill) {
      return [
        ...
        } }, h("div", { class: "notch-spacer", "aria-hidden": "true", ref: /* @__PURE__ */ __name((el) => this.notchSpacerEl = el, "ref") }, this.label)), h("div", { class: "select-outline-end" })),
        this.renderLabel()
      ];
    }
  ...
  get ariaLabel() {
    ...
    const displayValue = this.getText();
    const definedLabel = (_a4 = inheritedAttributes["aria-label"]) !== null && _a4 !== void 0 ? _a4 : this.labelText;
  ...
  renderListbox() {
    ...
    return h("button", { disabled, id: inputId, "aria-label": this.ariaLabel, "aria-haspopup": "dialog", "aria-expanded": `${isExpanded}`, "aria-describedby": this.getHintTextID(), "aria-invalid": this.getHintTextID() === this.errorTextId, "aria-required": `${required}`, onFocus: this.onFocus, onBlur: this.onBlur, ref: /* @__PURE__ */ __name((focusEl) => this.focusEl = focusEl, "ref") });
  }
  getHintTextID() {
...
var getOptionValue = /* @__PURE__ */ __name((el) => {
...
var generateText = /* @__PURE__ */ __name((opts, value, compareWith) => {
  if (value === void 0) {
    return "";
  }
  if (Array.isArray(value)) {
...
var textForValue = /* @__PURE__ */ __name((opts, value, compareWith) => {
...
var SelectPopover = (_a3 = class {
  ...
  renderCheckboxOptions(options) {
    ...
    }, getClassMap(option.cssClass)) }, h("ion-checkbox", { value: option.value, disabled: option.disabled, checked: option.checked, justify: "start", labelPlacement: "end", onIonChange: /* @__PURE__ */ __name((ev) => {
      this.setChecked(ev);
      this.callOptionHandler(ev);
      forceUpdate(this);
    }, "onIonChange") }, option.text)));
  }
  renderRadioOptions(options) {
    const checked = options.filter((o) => o.checked).map((o) => o.value)[0];
    return h("ion-radio-group", { value: checked, onIonChange: /* @__PURE__ */ __name((ev) => this.callOptionHandler(ev), "onIonChange") }, options.map((option) => h("ion-item", { class: Object.assign({
      // TODO FW-4784
      "item-radio-checked": option.value === checked
    }, getClassMap(option.cssClass)) }, h("ion-radio", { value: option.value, disabled: option.disabled, onClick: /* @__PURE__ */ __name(() => this.dismissParentPopover(), "onClick"), onKeyUp: /* @__PURE__ */ __name((ev) => {
      if (ev.key === " ") {
...
@ionic/core/dist/esm/ion-select_3.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-select_3.entry-WSMRGGKH.js.map
