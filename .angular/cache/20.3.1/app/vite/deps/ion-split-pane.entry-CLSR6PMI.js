...
var SplitPane = (_a = class {
  ...
  updateState() {
    ...
    const callback = /* @__PURE__ */ __name((q) => {
...
}, __name(_a, "SplitPane"), _a);
var setPaneClass = /* @__PURE__ */ __name((el, isMain) => {
  let toAdd;
  let toRemove;
  if (isMain) {
...
@ionic/core/dist/esm/ion-split-pane.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-split-pane.entry-CLSR6PMI.js.map
