...
var Checkbox = (_a = class {
  ...
  render() {
    ...
    }), onClick: this.onClick }, h("label", { key: "f025cec5ff08e8be4487b9cc0324616ca5dfae2a", class: "checkbox-wrapper", htmlFor: inputId }, h("input", Object.assign({ key: "dc53f7e4e240dc2e18556e6350df2b5c3169f553", type: "checkbox", checked: checked ? true : void 0, disabled, id: inputId, onChange: this.toggleChecked, onFocus: /* @__PURE__ */ __name(() => this.onFocus(), "onFocus"), onBlur: /* @__PURE__ */ __name(() => this.onBlur(), "onBlur"), ref: /* @__PURE__ */ __name((focusEl) => this.focusEl = focusEl, "ref"), required }, inheritedAttributes)), h("div", { key: "a625e9b50c3b617de8bbbfd624d772454fecaf2d", class: {
...
@ionic/core/dist/esm/ion-checkbox.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-checkbox.entry-ODGYZEL7.js.map
