...
var isSameDay = /* @__PURE__ */ __name((baseParts, compareParts) => {
  return baseParts.month === compareParts.month && baseParts.day === compareParts.day && baseParts.year === compareParts.year;
}, "isSameDay");
var isBefore = /* @__PURE__ */ __name((baseParts, compareParts) => {
...
var isAfter = /* @__PURE__ */ __name((baseParts, compareParts) => {
  return !!(baseParts.year > compareParts.year || baseParts.year === compareParts.year && baseParts.month > compareParts.month || baseParts.year === compareParts.year && baseParts.month === compareParts.month && baseParts.day !== null && baseParts.day > compareParts.day);
}, "isAfter");
var warnIfValueOutOfBounds = /* @__PURE__ */ __name((value, min, max) => {
...
var getHourCycle = /* @__PURE__ */ __name((locale, hourCycle) => {
  if (hourCycle !== void 0) {
    return hourCycle;
  }
...
var is24Hour = /* @__PURE__ */ __name((hourCycle) => {
  return hourCycle === "h23" || hourCycle === "h24";
}, "is24Hour");
var getNumDaysInMonth = /* @__PURE__ */ __name((month, year) => {
  return month === 4 || month === 6 || month === 9 || month === 11 ? 30 : month === 2 ? isLeapYear(year) ? 29 : 28 : 31;
}, "getNumDaysInMonth");
var isMonthFirstLocale = /* @__PURE__ */ __name((locale, formatOptions = {
  month: "numeric",
  year: "numeric"
}) => {
...
var isLocaleDayPeriodRTL = /* @__PURE__ */ __name((locale) => {
...
var convertToArrayOfNumbers = /* @__PURE__ */ __name((input) => {
  if (input === void 0) {
    return;
  }
...
var getPartsFromCalendarDay = /* @__PURE__ */ __name((el) => {
  return {
...
var clampDate = /* @__PURE__ */ __name((dateParts, minParts, maxParts) => {
...
var parseAmPm = /* @__PURE__ */ __name((hour) => {
  return hour >= 12 ? "pm" : "am";
}, "parseAmPm");
var parseMaxParts = /* @__PURE__ */ __name((max, todayParts) => {
...
var parseMinParts = /* @__PURE__ */ __name((min, todayParts) => {
...
var twoDigit = /* @__PURE__ */ __name((val) => {
  return ("0" + (val !== void 0 ? Math.abs(val) : "0")).slice(-2);
}, "twoDigit");
var fourDigit = /* @__PURE__ */ __name((val) => {
...
__name(convertDataToISO, "convertDataToISO");
var convert12HourTo24Hour = /* @__PURE__ */ __name((hour, ampm) => {
  if (ampm === void 0) {
    return hour;
  }
  if (ampm === "am") {
...
var getStartOfWeek = /* @__PURE__ */ __name((refParts) => {
...
var getEndOfWeek = /* @__PURE__ */ __name((refParts) => {
  const { dayOfWeek } = refParts;
  if (dayOfWeek === null || dayOfWeek === void 0) {
    throw new Error("No day of week provided");
  }
...
var getNextDay = /* @__PURE__ */ __name((refParts) => {
  return addDays(refParts, 1);
}, "getNextDay");
var getPreviousDay = /* @__PURE__ */ __name((refParts) => {
  return subtractDays(refParts, 1);
}, "getPreviousDay");
var getPreviousWeek = /* @__PURE__ */ __name((refParts) => {
  return subtractDays(refParts, 7);
}, "getPreviousWeek");
var getNextWeek = /* @__PURE__ */ __name((refParts) => {
  return addDays(refParts, 7);
}, "getNextWeek");
var subtractDays = /* @__PURE__ */ __name((refParts, numDays) => {
...
var addDays = /* @__PURE__ */ __name((refParts, numDays) => {
  const { month, day, year } = refParts;
  if (day === null) {
    throw new Error("No day provided");
  }
...
var getPreviousMonth = /* @__PURE__ */ __name((refParts) => {
...
var getNextMonth = /* @__PURE__ */ __name((refParts) => {
...
var changeYear = /* @__PURE__ */ __name((refParts, yearDelta) => {
...
var getPreviousYear = /* @__PURE__ */ __name((refParts) => {
  return changeYear(refParts, -1);
}, "getPreviousYear");
var getNextYear = /* @__PURE__ */ __name((refParts) => {
  return changeYear(refParts, 1);
}, "getNextYear");
var getInternalHourValue = /* @__PURE__ */ __name((hour, use24Hour, ampm) => {
  if (use24Hour) {
    return hour;
  }
  return convert12HourTo24Hour(hour, ampm);
}, "getInternalHourValue");
var calculateHourFromAMPM = /* @__PURE__ */ __name((currentParts, newAMPM) => {
...
var validateParts = /* @__PURE__ */ __name((parts, minParts, maxParts) => {
...
var getClosestValidDate = /* @__PURE__ */ __name(({ refParts, monthValues, dayValues, yearValues, hourValues, minuteValues, minParts, maxParts }) => {
...
var findClosestValue = /* @__PURE__ */ __name((reference, values) => {
...
var getFormattedDayPeriod = /* @__PURE__ */ __name((dayPeriod) => {
  if (dayPeriod === void 0) {
    return "";
  }
  return dayPeriod.toUpperCase();
}, "getFormattedDayPeriod");
var stripTimeZone = /* @__PURE__ */ __name((formatOptions) => {
...
var getLocalizedTime = /* @__PURE__ */ __name((locale, refParts, hourCycle, formatOptions = { hour: "numeric", minute: "numeric" }) => {
  const timeParts = {
    hour: refParts.hour,
...
var addTimePadding = /* @__PURE__ */ __name((value) => {
...
var getFormattedHour = /* @__PURE__ */ __name((hour, hourCycle) => {
  if (hour === 0) {
    switch (hourCycle) {
      case "h11":
        return "0";
...
var generateDayAriaLabel = /* @__PURE__ */ __name((locale, today, refParts) => {
...
var getMonthAndYear = /* @__PURE__ */ __name((locale, refParts) => {
  const date = getNormalizedDate(refParts);
  return new Intl.DateTimeFormat(locale, { month: "long", year: "numeric", timeZone: "UTC" }).format(date);
}, "getMonthAndYear");
var getDay = /* @__PURE__ */ __name((locale, refParts) => {
  return getLocalizedDateTimeParts(locale, refParts, { day: "numeric" }).find((obj) => obj.type === "day").value;
}, "getDay");
var getYear = /* @__PURE__ */ __name((locale, refParts) => {
...
var getLocalizedDateTimeParts = /* @__PURE__ */ __name((locale, refParts, options) => {
  const date = getNormalizedDate(refParts);
  return getDateTimeFormat(locale, options).formatToParts(date);
}, "getLocalizedDateTimeParts");
var getDateTimeFormat = /* @__PURE__ */ __name((locale, options) => {
  return new Intl.DateTimeFormat(locale, Object.assign(Object.assign({}, options), { timeZone: "UTC" }));
}, "getDateTimeFormat");
var getTodayLabel = /* @__PURE__ */ __name((locale) => {
...
var removeDateTzOffset = /* @__PURE__ */ __name((date) => {
...
var getLocalizedDayPeriod = /* @__PURE__ */ __name((locale, dayPeriod) => {
...
var getDaysOfWeek = /* @__PURE__ */ __name((locale, mode, firstDayOfWeek = 0) => {
...
var getDaysOfMonth = /* @__PURE__ */ __name((month, year, firstDayOfWeek, showAdjacentDays = false) => {
  const numDays = getNumDaysInMonth(month, year);
  let previousNumDays;
  if (month === 1) {
...
var getHourData = /* @__PURE__ */ __name((hourCycle) => {
  switch (hourCycle) {
    case "h11":
      return hour11;
    case "h12":
...
var generateTime = /* @__PURE__ */ __name((locale, refParts, hourCycle = "h12", minParts, maxParts, hourValues, minuteValues) => {
...
var generateMonths = /* @__PURE__ */ __name((refParts, forcedDate) => {
...
var getMonthColumnData = /* @__PURE__ */ __name((locale, refParts, minParts, maxParts, monthValues, formatOptions = {
  month: "long"
}) => {
  const { year } = refParts;
  const months = [];
...
var getDayColumnData = /* @__PURE__ */ __name((locale, refParts, minParts, maxParts, dayValues, formatOptions = {
  day: "numeric"
}) => {
...
var getAllMonthsInRange = /* @__PURE__ */ __name((currentParts, maxParts) => {
  if (currentParts.month === maxParts.month && currentParts.year === maxParts.year) {
    return [currentParts];
  }
  return [currentParts, ...getAllMonthsInRange(getNextMonth(currentParts), maxParts)];
}, "getAllMonthsInRange");
var getCombinedDateColumnData = /* @__PURE__ */ __name((locale, todayParts, minParts, maxParts, dayValues, monthValues) => {
  let items = [];
  let parts = [];
...
var getTimeColumnsData = /* @__PURE__ */ __name((locale, refParts, hourCycle, minParts, maxParts, allowedHourValues, allowedMinuteValues) => {
  const computedHourCycle = getHourCycle(locale, hourCycle);
  const use24Hour = is24Hour(computedHourCycle);
...
@ionic/core/dist/esm/data-CKHMWxfe.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-6F5D226O.js.map
