...
var _a;
var InputPasswordToggle = (_a = class {
  constructor(hostRef) {
  ...
  render() {
    ...
    const showPasswordIcon = (_a2 = this.showIcon) !== null && _a2 !== void 0 ? _a2 : eye;
    const hidePasswordIcon = (_b = this.hideIcon) !== null && _b !== void 0 ? _b : eyeOff;
    const isPasswordVisible = type === "text";
    return h(Host, { key: "91bc55664d496fe457518bd112865dd7811d0c17", class: createColorClasses(color, {
      [mode]: true
    }) }, h("ion-button", { key: "f3e436422110c9cb4d5c0b83500255b24ab4cdef", mode, color, fill: "clear", shape: "round", "aria-checked": isPasswordVisible ? "true" : "false", "aria-label": isPasswordVisible ? "Hide password" : "Show password", role: "switch", type: "button", onPointerDown: /* @__PURE__ */ __name((ev) => {
      ev.preventDefault();
    }, "onPointerDown"), onClick: this.togglePasswordVisibility }, h("ion-icon", { key: "5c8b121153f148f92aa7cba0447673a4f6f3ad1e", slot: "icon-only", "aria-hidden": "true", icon: isPasswordVisible ? hidePasswordIcon : showPasswordIcon })));
  }
  get el() {
...
}, __name(_a, "InputPasswordToggle"), _a);
...
@ionic/core/dist/esm/ion-input-password-toggle.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-input-password-toggle.entry-5POY7VWC.js.map
