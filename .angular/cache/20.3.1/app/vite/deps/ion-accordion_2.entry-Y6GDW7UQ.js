...
var Accordion = (_a = class {
  ...
  connectedCallback() {
    var _a3;
    const accordionGroupEl = this.accordionGroupEl = (_a3 = this.el) === null || _a3 === void 0 ? void 0 : _a3.closest("ion-accordion-group");
    if (accordionGroupEl) {
  ...
  render() {
    ...
    } }, h("div", { key: "9b4cf326de8bb6b4033992903c0c1bfd7eea9bcc", onClick: /* @__PURE__ */ __name(() => this.toggleExpanded(), "onClick"), id: "header", part: headerPart, "aria-controls": "content", ref: /* @__PURE__ */ __name((headerEl) => this.headerEl = headerEl, "ref") }, h("slot", { key: "464c32a37f64655eacf4218284214f5f30b14a1e", name: "header" })), h("div", { key: "8bb52e6a62d7de0106b253201a89a32e79d9a594", id: "content", part: contentPart, role: "region", "aria-labelledby": "header", ref: /* @__PURE__ */ __name((contentEl) => this.contentEl = contentEl, "ref") }, h("div", { key: "1d9dfd952ad493754aaeea7a8f625b33c2dd90a0", id: "content-wrapper", ref: /* @__PURE__ */ __name((contentElWrapper) => this.contentElWrapper = contentElWrapper, "ref") }, h("slot", { key: "970dfbc55a612d739d0ca3b7b1a08e5c96d0c479", name: "content" }))));
  }
...
@ionic/core/dist/esm/ion-accordion_2.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-accordion_2.entry-Y6GDW7UQ.js.map
